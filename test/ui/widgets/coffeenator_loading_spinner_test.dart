...
void main() {
  group('CoffeenatorLoadingSpinner', () {
    testWidgets('renders CircularProgressIndicator with background color as primary color from ColorScheme', (tester) async {
      const expectedSpinnerColor = Colors.orange;
      final theme = ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.amber).copyWith(primary: expectedSpinnerColor),
      );
